...
## Example
An example React app is available in [this GitHub repository](https://blog.mdavid626.com/2019/03/31/How-to-use-HTML-entities-without-dangerouslySetInnerHTML/) and [here](https://mdavid626.github.io/react-html-entities-example/) is the live example app.